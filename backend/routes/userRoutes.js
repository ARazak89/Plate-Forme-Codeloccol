...
import { me, unblock, updateUserNameAndEmail, updateUserPassword, updateUserProfilePicture, listUsers, getUserById, updateUserRole, deleteUser } from '../controllers/userController.js';
...
r.put('/me/profile-picture', requireAuth, upload.single('profilePicture'), updateUserProfilePicture); // Modifier la photo de profil avec upload de fichier

// Routes accessibles uniquement au staff/admin
r.put('/:id/info', requireAuth, requireRole(['staff','admin']), updateUserNameAndEmail); // Modifier nom et email (par staff/admin)
