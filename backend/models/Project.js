...
const projectSchema = new mongoose.Schema({
  ...
  status: { type: String, enum: ['assigned', 'pending', 'approved', 'rejected', 'awaiting_staff_review', 'template'], default: 'assigned' }, // Nouveau statut 'awaiting_staff_review' et 'template'
  student: { type: mongoose.Schema.Types.ObjectId, ref: 'User', required: false }, // student devient optionnel pour les templates
  templateProject: { type: mongoose.Schema.Types.ObjectId, ref: 'Project', required: false }, // Référence au projet template d'origine
